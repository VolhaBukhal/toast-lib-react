...
import r, { useState, useEffect, useRef, useDebugValue, useContext, createElement, forwardRef, useImperativeHandle } from 'react';
...
var ToastPortalMargin;
(function (ToastPortalMargin) {
    ToastPortalMargin["NONE"] = "none";
    ToastPortalMargin["SMALL"] = "small";
    ToastPortalMargin["MEDIUM"] = "medium";
    ToastPortalMargin["LARGE"] = "large";
})(ToastPortalMargin || (ToastPortalMargin = {}));
var ToastPortalPosition;
(function (ToastPortalPosition) {
    ToastPortalPosition["TOP_RIGHT"] = "topRight";
    ToastPortalPosition["TOP_LEFT"] = "topLeft";
    ToastPortalPosition["BOTTOM_RIGHT"] = "bottomRight";
    ToastPortalPosition["BOTTOM_LEFT"] = "bottomLeft";
})(ToastPortalPosition || (ToastPortalPosition = {}));
...
var ToastService = /** @class */ (function () {
    function ToastService() {
        ...
        this.generateToast = function (toastOptions) {
            return __assign({ id: v4() }, toastOptions);
        };
...
(function (AnimationMode) {
    ...
    AnimationMode["SCALE"] = "scale";
    AnimationMode["MOVE"] = "move";
...
var fadeIn = We(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n 0% { opacity: 0 }\n 100% { opacity: 1 }\n"], ["\n 0% { opacity: 0 }\n 100% { opacity: 1 }\n"])));
var scaleUp = We(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n 0% { transform: scale(0) }\n 100% {transform: scale(1) }\n"], ["\n 0% { transform: scale(0) }\n 100% {transform: scale(1) }\n"])));
var fromRight = We(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n 0% { right: -110%; }\n 100% { right: 0%; }\n"], ["\n 0% { right: -110%; }\n 100% { right: 0%; }\n"])));
var fromLeft = We(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n 0% { left: -110%; }\n 100% { left: 0%; }\n"], ["\n 0% { left: -110%; }\n 100% { left: 0%; }\n"])));
var setAnimationName = function (animationType, position) {
...
var StyledToast = qe.div(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n  width: ", "px;\n  display: flex;\n  flex-direction: column;\n  min-height: ", "px;\n  position: relative;\n  right: ", "%;\n  align-items: center;\n  justify-content: center;\n  background-color: ", ";\n\n  opacity: 1;\n  padding: ", "px ", "px ", "px ", "px;\n  color: ", ";\n  border-radius: ", "px;\n  box-sizing: border-box;\n  box-shadow: ", ";\n\n  animation-name: ", ";\n  animation-duration: ", "s;\n  animation-direction: ", ";\n  animation-fill-mode: forwards;\n\n  &:hover {\n    transition: ", "s;\n    transform: scale(0.95);\n    box-shadow: ", ";\n  }\n"], ["\n  width: ", "px;\n  display: flex;\n  flex-direction: column;\n  min-height: ", "px;\n  position: relative;\n  right: ", "%;\n  align-items: center;\n  justify-content: center;\n  background-color: ", ";\n\n  opacity: 1;\n  padding: ", "px ", "px ", "px ", "px;\n  color: ", ";\n  border-radius: ", "px;\n  box-sizing: border-box;\n  box-shadow: ", ";\n\n  animation-name: ", ";\n  animation-duration: ", "s;\n  animation-direction: ", ";\n  animation-fill-mode: forwards;\n\n  &:hover {\n    transition: ", "s;\n    transform: scale(0.95);\n    box-shadow: ", ";\n  }\n"])), theme.widths[1], theme.widths[0], theme.positions[0], function (_a) {
...
}, theme.spaces[1], theme.spaces[3], theme.spaces[3], theme.spaces[3], theme.colors.white, theme.borderRadius, theme.boxShadow, function (_a) {
    var animationType = _a.animationType, position = _a.position;
    return setAnimationName(animationType, position);
}, theme.duration.ms300, function (_a) {
    var reverse = _a.reverse;
    return (reverse ? 'reverse' : '');
}, theme.duration.ms300, theme.boxShadowHover);
var StyledCloseToast = qe.div(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n  position: absolute;\n  top: ", "px;\n  right: ", "px;\n  color: ", ";\n  cursor: pointer;\n"], ["\n  position: absolute;\n  top: ", "px;\n  right: ", "px;\n  color: ", ";\n  cursor: pointer;\n"])), theme.positions[1] / 2, theme.positions[1], theme.colors.white);
var StyledTitle = qe.div(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  align-self: start;\n"], ["\n  align-self: start;\n"])));
var templateObject_1$1, templateObject_2$1, templateObject_3$1, templateObject_4$1, templateObject_8$1, templateObject_9$1, templateObject_10;

var Toast = function (_a) {
    var _b = _a.title, title = _b === void 0 ? 'Infor' : _b, _c = _a.mode, mode = _c === void 0 ? 'info' : _c, _d = _a.message, message = _d === void 0 ? 'Example of info toast' : _d, backgroundColor = _a.backgroundColor, _e = _a.animationType, animationType = _e === void 0 ? AnimationMode.SCALE : _e, _f = _a.position, position = _f === void 0 ? ToastPortalPosition.TOP_RIGHT : _f, onClose = _a.onClose, onDragDelete = _a.onDragDelete;
    var _g = useState(false), reverse = _g[0], setReverse = _g[1];
    useEffect(function () {
        setReverse(false);
    }, [setReverse]);
    ...
    return (jsxs(StyledToast, __assign({ mode: mode, backgroundColor: backgroundColor, reverse: reverse, animationType: animationType, position: position, draggable: true, onClick: onToastClose, onDragEnd: onDragDelete }, { children: [jsx(StyledTitle, { children: title }), jsx("p", { children: message }), jsx(StyledCloseToast, __assign({ onClick: onToastClose }, { children: "\u2715" }))] })));
};

var setPosition = function (position) {
    switch (position) {
        case ToastPortalPosition.BOTTOM_LEFT: {
            return Ae(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n        bottom: ", "px;\n        left: ", "px;\n      "], ["\n        bottom: ", "px;\n        left: ", "px;\n      "])), theme.positions[1], theme.positions[1]);
        }
...
var setMargin = function (margin) {
    switch (margin) {
        ...
        case ToastPortalMargin.MEDIUM: {
            return Ae(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        margin: ", "px;\n      "], ["\n        margin: ", "px;\n      "])), theme.positions[1]);
        }
        case ToastPortalMargin.LARGE: {
            return Ae(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n        margin: ", "px;\n      "], ["\n        margin: ", "px;\n      "])), theme.positions[2]);
        }
        default:
            return Ae(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n        margin: ", "px;\n      "], ["\n        margin: ", "px;\n      "])), theme.positions[0]);
    }
};
var ToastContainer = qe.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  gap: ", "px;\n  ", ";\n  position: fixed;\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  gap: ", "px;\n  ", ";\n  position: fixed;\n  ", "\n"])), theme.positions[1], function (_a) {
...
var ToastPortal = forwardRef(function (_a, ref) {
    var _b = _a.autoClose, autoClose = _b === void 0 ? false : _b, _c = _a.autoCloseTime, autoCloseTime = _c === void 0 ? 4000 : _c, _d = _a.position, position = _d === void 0 ? ToastPortalPosition.TOP_RIGHT : _d, _e = _a.margin, margin = _e === void 0 ? ToastPortalMargin.NONE : _e;
    ...
    return loaded
        ? ReactDOM.createPortal(jsx(ToastContainer, __assign({ position: position, autoClose: autoClose, autoCloseTime: autoCloseTime, margin: margin }, { children: toasts.map(function (_a) {
                var title = _a.title, id = _a.id, mode = _a.mode, message = _a.message, animationType = _a.animationType, backgroundColor = _a.backgroundColor, position = _a.position;
                return (jsx(Toast, { title: title, mode: mode, message: message, backgroundColor: backgroundColor, animationType: animationType, onClose: handleClose(id), onDragDelete: handleClose(id), position: position }, id));
