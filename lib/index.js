...
var Toast = function (_a) {
    ...
    var _g = r.useState(false), reverse = _g[0], setReverse = _g[1];
    r.useEffect(function () {
        setReverse(false);
    }, [setReverse]);
    ...
    return (jsxRuntime.jsxs(StyledToast, __assign({ mode: mode, backgroundColor: backgroundColor, reverse: reverse, animationType: animationType, position: position, draggable: true, onClick: onToastClose, onDragEnd: onDragDelete }, { children: [jsxRuntime.jsx(StyledTitle, { children: title }), jsxRuntime.jsx("p", { children: message }), jsxRuntime.jsx(StyledCloseToast, __assign({ onClick: onToastClose }, { children: "\u2715" }))] })));
};
...
var ToastPortal = r.forwardRef(function (_a, ref) {
    ...
    return loaded
        ? ReactDOM__default["default"].createPortal(jsxRuntime.jsx(ToastContainer, __assign({ position: position, autoClose: autoClose, autoCloseTime: autoCloseTime, margin: margin }, { children: toasts.map(function (_a) {
                ...
                return (jsxRuntime.jsx(Toast, { title: title, mode: mode, message: message, backgroundColor: backgroundColor, animationType: animationType, onClose: handleClose(id), onDragDelete: handleClose(id), position: position }, id));
